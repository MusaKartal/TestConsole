...
namespace TestConsole
{
    public class Text
    {
        ...
        public async Task<List<string>> Basic() {
            ...
            if (mainTextMod != 0) textToBeWritten.Add(mainText.Substring(mainTextLength - mainTextMod));
